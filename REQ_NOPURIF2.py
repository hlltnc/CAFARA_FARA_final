...
# Skaler kapasiteyi 'capacity' alanına yaz (listeyi ezmeyelim)
    ...
    # 3. Path ve hesaplamalar
            ...
            for path in paths:
                ...
                successful_purification_rounds=0
...
# ---- C_real’i her path için ekle ----
    ...
    # ----- Buradan sonrası sadece decision="ok" için -----
            ...
            if valid_path:
                t_ent_gen = valid_path.get("t_ent_gen", float("inf"))
                t_swapping = valid_path.get("t_swap", float("inf"))
                t_purif   = valid_path.get("t_purif", float("inf"))
                t_total   = t_ent_gen + t_swapping 
...
def save_results_npz(
    ...
    All_req_t_ent,
    All_req_t_purif,
    out_path="REQ_NOPUR_FTH_C_TH08_C_100_Node10_npz/REQ1_metrics.npz"
):
    """
...
save_results_npz(
    ...
    All_req_t_ent,
    All_req_t_purif,
    out_path="REQ_NOPUR_FTH_C_TH08_C100_Node10_npz/REQ1_metrics.npz"
)
